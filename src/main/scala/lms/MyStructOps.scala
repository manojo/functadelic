...
trait StructOpsExpOpt extends StructOpsExp {
...
trait StructOpsExpOptCommon extends StructOpsExpOpt with VariablesExp with IfThenElseExp {
...
trait BaseGenFatStructOps extends GenericFatCodegen {
  val IR: StructOpsFatExpOptCommon // TODO: restructure traits, maybe move this to if then else codegen?
  import IR._
...
trait ScalaGenFatStructOps extends ScalaGenStructOps with BaseGenFatStructOps {
  val IR: StructOpsFatExpOptCommon // TODO: restructure traits, maybe move this to if then else codegen?
  import IR._
...
trait BaseGenStructOps extends GenericNestedCodegen {
  val IR: StructOpsExp
  import IR._
...
trait ScalaGenStructOps extends ScalaGenBase with BaseGenStructOps {
  val IR: StructOpsExp
  import IR._
